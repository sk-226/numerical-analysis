...
def _plot_category_boxplot(
    ...
    *,
    ...
    print(
        f"Saved boxplot for category '{category_key}' "
...
def plot_normalized_iterations_by_condition_category(
    ...
    output_name_template: str = "normalized_iterations_by_prec_{category}_converged_only.svg",
...
if __name__ == "__main__":
    ...
    print("Generating normalized iteration boxplots by condition category...")
